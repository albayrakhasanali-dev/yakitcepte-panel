...
export default function PurchaseDetailPage() {
  ...
  useEffect(() => {
    api.get(`/purchases/${id}`).then(r => setData(r.data)).catch(() => setError(true));
  }, [id]);

  if (error) return <div className="text-center py-20 text-gray-500">Alış bulunamadı veya erişim reddedildi.</div>;
